...
One can observe that highest accuracy was got by the highest learning rate. The smaller the learning rate the worse the performace. This is because out network is simple and we do not need warmup steps. But, readers can set higher learning rates to see how the lookhead mechanism behave in this case.
