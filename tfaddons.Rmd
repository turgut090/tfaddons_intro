...
7. After delivering the output to the final Enocder_6, internal representation of vectors is transferred to the stack of decoders. Wha is new here on the right side?
...
In order to predict first 3 words "I love R" first we encode them like dimensions: "1 2 3" and then German version as "4 5 6". What are we doing here?
...
But we have forgotten to mention new callbacks! Now it is possible to stop training after certain time and even get a progress bar while training a model. Just pass callbacks as usual into ```fit``` function:
