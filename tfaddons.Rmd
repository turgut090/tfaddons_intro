...
```{r eval=T,echo=T,layout="l-screen-inset",fig.height=10}
library(DiagrammeR)
grViz("
digraph boxes_and_circles {
  ...
  Add_Norm__ [style = filled, fillcolor = cornflowerblue,fontcolor=white]
    ...
    Feed_Forward__NN->Encoder_Decoder_Attention
  ...
  edge [arrowhead=vee]
  node [color=violet, shape =plaintext,fontsize = 45, fontcolor=blue]
  Transformer->{Encoder_6, Decoder_6}
