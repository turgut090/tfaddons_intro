...
But we have forgot to mention new callbacks! Now it is possible to stop training after certain time and even get a progress bar while training a model. Just pass callbacks as usual into ```fit``` function:
